...
var TinyMCE_PreviewPlugin = {getInfo: function () {
    ...
    switch (command) {
        case"mcePreview":
            ...
            if (previewPage) {
                ...
                for (i = 0; i < css.length; i++)html += '<link href="' + css[i] + '" rel="stylesheet" type="text/css" />';
    ...
    for (i = 0; i < nl.length; i++) {
        ...
        if (new RegExp('write(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia)\\(.*', 'g').test(sv))el[el.length] = nl[i]
    }
